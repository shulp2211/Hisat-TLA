...
def simulate_reads():
	...
	["22-50TC", 1000000, _dna, not _snp, not _mismatch, _constant],
	["22-50TC", 1000000, _rna, not _snp, not _mismatch, _constant],
	["22-50TC", 1000000, _rna, not _snp, _mismatch, _constant],
	["22-50TC", 1000000, _rna, _snp, not _mismatch, _constant]
	#["22", 1000000, _dna, not _snp, not _mismatch, _constant],
